...
public class Java_sql_proj {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        stmt.execute("insert into studs values (1, 'Bobby', 89, 'bobby@mail.com', 'Vizag')");
        stmt.execute("insert into studs values (2, 'Srikar', 91, 'srikar@mail.com', 'Vizag')");    
        stmt.execute("insert into studs values (3, 'Bharadwaj', 75, 'bharadwaj@mail.com', 'Mumbai')");
        stmt.execute("insert into studs values (4, 'Adi', 92, 'adi@mail.com', 'Chennai')");
